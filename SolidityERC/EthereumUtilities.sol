...
contract EthereumUtilities is Owned {
    ...
    function getBlockhash(uint bn) public constant returns (bytes32) {
    ...
    function getGasLimit() public constant returns (uint) {
    ...
    function getGasLeft() public constant returns (uint256) {
    ...
    function getWeiSent() public constant returns (uint) {
        
        return msg.value;
    }
    
    function getTxnGas() public constant returns (uint) {
        
        return tx.gasprice;
    }
    
    function getTxChain() public constant returns (address) {
